          ...
          <div className='w-full md:w-1/2 p-8 md:p-12'>
            ...
            {/* form section  */}
              ...
              <div className='text-center'>
                ...
                <p className='text-gray-600 mb-8 text-md'>Join our community and unlock exclusive features</p>
              </div>
              ...
              <form onSubmit={(handleSubmit)} className='space-y-6'>
                ...
                {/* full name */}
                  ...
                  {/* button */}
                  <button type='submit'  className='w-full bg-amber-400 hover:bg-amber-500 text-gray-900 cursor-pointer py-3 rounded-full text-md font-semibold'>Create Account</button>
                   </form>
                  {/* devider */}
                  ...
                  <div className='flex justify-between flex-col sm:flex-row items-center mt-10 text-sm text-gray-600'>
                    <button onClick={switchToLogin} className='hover:text-yellow-600 transition duration-200 mb-2 sm:mb-0 cursor-pointer'>
                      Have any account ?
